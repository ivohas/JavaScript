...
describe('E2E tests', function () {
    ...
    describe('Dashboard Page [ 15 Points ]', () => {
        it('Show Dashboard page - welcome message [ 1 Points ]', async () => {
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it('Check Dashboard page with 0 pets [ 3 Points ]', async () => {
        ...
        it('Check dashboard page with 2 pets [ 5 Points ]', async () => {
            const { get } = await handle(endpoints.catalog);
        ...
        it('Check dashboard page Info [ 4 Points ]', async () => {
            const { get } = await handle(endpoints.catalog);
    ...
    describe('BONUS : Donate functionality  [ 10 Points ]', async () => {

        it('Donate button is NOT visible for guest users [ 1 Points ]', async () => {
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it('Donate button is visible for the non-creator user [ 2 Points ]', async () => {
            // Login user
            const user = mockData.users[0];
            const data = mockData.catalog[2];
        ...
        it('Donate button is NOT visible for the creator [ 2 Points ]', async () => {
            // Login user
            const user = mockData.users[0];
            const data = mockData.catalog[0];
        ...
        it('Donate button should be hidden(not visible) after a click on it [ 2 Points ]', async () => {
            // Login user
            const user = mockData.users[0];
            const data = mockData.catalog[2];
        ...
        it('Donate button should increase total donation by 100 after a click on it [ 3 Points ]', async () => {
            // Login user
            const user = mockData.users[0];
            const data = mockData.catalog[2];
            await page.goto(host);
